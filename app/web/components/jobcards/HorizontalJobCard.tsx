...
export const HorizontalJobCard = ({ title, description, jobId }: { title: string; description: string; jobId: string }) => {
  return (
    <div 
      className="w-full flex flex-row bg-white rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 hover:shadow-teal-200/50 transition-all duration-200"
    >
      ...
      <div 
        className="flex items-center gap-4 p-6 border-l border-gray-100"
      >
